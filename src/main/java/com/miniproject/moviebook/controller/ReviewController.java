...
public class ReviewController {
    ...
    //해당 영화 리뷰 목록 조회
    @GetMapping("/api/reviews/list/{m_id}")
    ...
    //해당 영화 리뷰 작성
    @PostMapping("/api/reviews/authentication/{m_id}")
    public Map<String, String> createReview(@PathVariable Long m_id, @RequestBody  ReviewRequestDto requestDto) {
        return reviewService.createReview(requestDto, m_id);
    }

    //해당 영화 리뷰 수정
    @PutMapping("/api/reviews/authentication/{r_id}")
    public Map<String, String> updateReview(@PathVariable Long r_id, @RequestBody ReviewRequestDto requestDto) {
        return reviewService.updateReview(requestDto, r_id);
    }

    //해당 영화 리뷰 삭제
    @DeleteMapping("/api/reviews/authentication/{r_id}")
    public Map<String, String> deleteReview(@PathVariable Long r_id) {
